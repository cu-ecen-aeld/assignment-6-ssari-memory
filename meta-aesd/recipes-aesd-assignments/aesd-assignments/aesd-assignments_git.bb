...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-ssari-memory;protocol=ssh;branch=master"

PV = "1.0+git${SRCPV}"
# set to reference a specific commit hash in your assignment repo
SRCREV = "1542cee526b4dea64400b943d12f05af62d272cc"
